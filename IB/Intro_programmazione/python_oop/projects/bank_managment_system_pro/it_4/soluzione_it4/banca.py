...
class Banca: 
    ...
    def __repr__(self):
        return f"Nome banca {self.nome_banca} nazionalità {self.__nazione} numero totale di clienti {str(len(self.clienti))} numero totale di conti correnti {str(len(self.conti_correnti))}" 
